...
class Item():
    ...
    def __init__(self, id: str, slug: str, content_type: ContentType, title: str, overview: None, availability_pros: None, imdb_rating: Optional[float], rt_critics_rating: None, rg_content_score: None, has_poster: bool, poster_blur: None, has_backdrop: bool, backdrop_blur: None, released_on: Optional[datetime], classification: Optional[Classification], sources: List[str], genres: List[Any], on_services: bool, on_free: bool, on_rent_purchase: bool, user_rating: None, tracking: bool, watchlisted: bool, seen: bool, season_count: int, featured_services: List[Any], episode_source_count: int) -> None:
        self.id = id
        self.slug = slug
...
#  FIZ PARA USAR LISTA 
    def __init__(self, items: list[Item], page: int, pages: int, page_size: int) -> None:
        print(items)
        self.items = items
        self.page = page
        self.pages = pages
